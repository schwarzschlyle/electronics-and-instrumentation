...
// Global Variables
int DHT11_Pin = 12; // DHT11 Data Pin
...
servo.write(90);  // The servo was set to an initial angle state at 180 degrees
}
...
delay(dT/0.75);
servo.write(90); // Feedback control instructions were sent to the servo
delay(100);
}


if (dT < -0.5){
servo.write(0); // Servo is reset to 180 degrees after each loop
delay(dT/0.60);
servo.write(90); // Feedback control instructions were sent to the servo
delay(100);
}
